...
extension UIView {
    ...
    public func edgeTo(_ view: UIView,
                       safeArea: DViewSafeArea = .none) -> UIView {
    ...
    @discardableResult
    public func addScrollView(_ scrollView: DScrollView,
                              withSafeArea: DViewSafeArea = .none,
                              hasStatusBarCover: Bool = false,
                              statusBarBackgroundColor: UIColor = .white,
                              container: DScrollViewContainer,
                              elements: [UIView]) -> UIView {
